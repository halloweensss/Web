...
// CONCATENATED MODULE: ./src/mixinPropsUpdated.js


/* harmony default export */ var mixinPropsUpdated = ({
  computed: {
...
// CONCATENATED MODULE: ./src/SliderTrack.js
...
function SliderTrack_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function SliderTrack_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { SliderTrack_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { SliderTrack_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
/* harmony default export */ var SliderTrack = ({
  name: 'SliderTrack',
  ...
  methods: {
    ...
    renderSlides: function renderSlides(spec, children) {
      ...
      children.forEach(function (elem, index) {
        ...
        var childStyle = getSlideStyle(SliderTrack_objectSpread({}, spec, {
          index: index
        }));
        var slideClasses = getSlideClasses(SliderTrack_objectSpread({}, spec, {
          index: index
        ...
        slides.push(_this2.cloneSlide(child, {
          ...
          class: slideClasses,
          style: SliderTrack_objectSpread({
            outline: 'none'
          }, childStyle),
          attrs: {
            tabIndex: '-1',
        ...
        if (spec.infinite && spec.fade === false) {
          ...
          if (preCloneNo <= getPreClones(spec) && childrenCount !== spec.slidesToShow) {
            ...
            slideClasses = getSlideClasses(SliderTrack_objectSpread({}, spec, {
              index: key
            }));
...
// CONCATENATED MODULE: ./src/SliderArrow.js




/* harmony default export */ var SliderArrow = ({
  name: 'SliderArrow',
...
// CONCATENATED MODULE: ./src/SliderDots.js
...
/* harmony default export */ var SliderDots = ({
  name: 'SliderDots',
  props: PROP_KEYS.DOT,
  render: function render() {
    var _this = this;
...
// CONCATENATED MODULE: ./src/InnerSlider.js
...
function InnerSlider_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function InnerSlider_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { InnerSlider_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { InnerSlider_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
/* harmony default export */ var InnerSlider = ({
  name: 'InnerSlider',
  components: {
  ...
  inheritAttrs: false,
  props: InnerSlider_objectSpread({}, defaultProps_props, {
    unslick: {
      type: Boolean,
      default: false
    },
  ...
  data: function data() {
    return InnerSlider_objectSpread({}, initialState, {
  ...
  computed: {
    ...
    spec: function spec() {
      return InnerSlider_objectSpread({}, this.$props, {}, this.$data, {
        slideCount: this.slideCount
      });
    }
  },
  ...
  mounted: function mounted() {
    ...
    var spec = InnerSlider_objectSpread({
  ...
  updated: function updated() {
    ...
    if (this.lazyLoad) {
      var slidesToLoad = getOnDemandLazySlides(InnerSlider_objectSpread({}, this.$props, {}, this.$data));
  ...
  methods: {
    ...
    updateState: function updateState(spec, setTrackStyle) {
      ...
      spec = InnerSlider_objectSpread({}, spec, {}, updatedState, {
        slideIndex: updatedState.currentSlide
      });
      var targetLeft = getTrackLeft(spec);
      spec = InnerSlider_objectSpread({}, spec, {
        left: targetLeft
      });
    ...
    slideHandler: function slideHandler(index) {
      ...
      var _slideHandler2 = innerSliderUtils_slideHandler(InnerSlider_objectSpread({
        index: index
    ...
    progressiveLazyLoad: function progressiveLazyLoad() {
      ...
      var spec = InnerSlider_objectSpread({}, this.$props, {}, this.$data);
    ...
    swipeMove: function swipeMove(e) {
      ...
      var state = innerSliderUtils_swipeMove(e, InnerSlider_objectSpread({}, this.$props, {}, this.$data, {
        trackRef: this.$refs.track,
        listRef: this.$refs.list,
    ...
    swipeEnd: function swipeEnd(e) {
      var state = innerSliderUtils_swipeEnd(e, InnerSlider_objectSpread({}, this.$props, {}, this.$data, {
        trackRef: this.$refs.track,
        listRef: this.$refs.list,
        slideIndex: this.currentSlide
      }));
    ...
    play: function play() {
      ...
      if (this.rtl) {
        ...
        if (canGoNext(InnerSlider_objectSpread({}, this.$props, {}, this.$data))) {
          nextIndex = this.currentSlide + this.slidesToScroll;
        } else {
          return false;
        }
  ...
  render: function render() {
    ...
    trackProps = filterUndefined(InnerSlider_objectSpread({}, trackProps));
    ...
    if (this.dots === true && this.slideCount >= this.slidesToShow) {
      ...
      dots = h(SliderDots, {
        "props": InnerSlider_objectSpread({}, dotProps),
        "nativeOn": InnerSlider_objectSpread({}, dotNativeOn),
        "on": {
    ...
    if (this.arrows) {
      prevArrow = h(SliderArrow, {
        "props": InnerSlider_objectSpread({}, InnerSlider_objectSpread({}, arrowProps, {
          type: 'previous'
        })),
        "on": {
    ...
    var listStyle = InnerSlider_objectSpread({}, this.$parent.$vnode.data.style);

    if (!this.unslick) {
      listStyle = InnerSlider_objectSpread({}, listStyle, {}, filterUndefinedOrNull(verticalHeightStyle), {}, centerPaddingStyle);
    }
    ...
    return h("div", {
      ...
      "ref": "list",
      "class": 'slick-list',
      "on": InnerSlider_objectSpread({}, listOn),
      "style": listStyle
    }, [h(SliderTrack, {
      "ref": "track",
      "props": InnerSlider_objectSpread({}, trackProps),
      "nativeOn": InnerSlider_objectSpread({}, trackNativeOn),
      "on": {
...
// CONCATENATED MODULE: ./src/VueSlickCarousel.js
...
function VueSlickCarousel_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function VueSlickCarousel_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { VueSlickCarousel_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { VueSlickCarousel_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
/* harmony default export */ var VueSlickCarousel = ({
  ...
  computed: {
    settings: function settings() {
      ...
      if (this.breakpoint) {
        ...
        settings = newProps[0].settings === 'unslick' ? 'unslick' : VueSlickCarousel_objectSpread({}, defaultValues, {}, props, {}, newProps[0].settings);
      } else {
        settings = VueSlickCarousel_objectSpread({}, defaultValues, {}, props);
  ...
  render: function render() {
    ...
    return h(InnerSlider, {
      "ref": "innerSlider",
      "props": VueSlickCarousel_objectSpread({}, settings),
